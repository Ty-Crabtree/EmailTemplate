 ...
 * The structure of this class was determined by the expected update user response json message structure.
 *
...
public class UpdateUserResponse {
    ...
    public String toString() {
        return String.format("<<< UpdateUserResponse:  Users=%s  Success=%s  ErrorMessages=%s", 
