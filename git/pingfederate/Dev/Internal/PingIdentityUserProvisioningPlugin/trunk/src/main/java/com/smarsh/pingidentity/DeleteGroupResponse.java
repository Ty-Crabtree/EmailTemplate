 ...
 * The structure of this class was determined by the expected delete group response json message structure.
 *
 * @author Steve Fusti
 *
 */
...
public class DeleteGroupResponse {
    ...
    public String toString() {
        return String.format("<<< DeleteGroupResponse: Group=%s  Success=%s  ErrorMessages=%s",
